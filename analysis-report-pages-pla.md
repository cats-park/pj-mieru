...
**生成日時**: 2025/7/12 8:19:17
**参照元**: `/Users/sakaikatsufumi/Document/programming/GitHub/plaplat-v2`
...
### 言語構成
- **Vue.js**: 73% (70ファイル)
- **TypeScript**: 24% (23ファイル)
- **JavaScript**: 3% (3ファイル)

### フレームワーク/ライブラリ
- **Nuxt.js** v3.0.0 (信頼度: high)
- **Vue.js** v3.x (信頼度: high)
- **Vuetify** v3.6.10 (信頼度: high)
- **Vite** vnot specified (信頼度: medium)
- **TypeScript** v4.9.3 (信頼度: high)
- **ESLint** v8.29.0 (信頼度: high)
- **dotenv** v7.2.1 (信頼度: medium)
- **Sass** v1.62.1 (信頼度: medium)
